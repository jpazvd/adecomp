...
collapse (mean) weight icp2005 cpi2005 gall gallT health durables hhsize gall_ppp health_ppp durables_ppp (sum) totinc_def oinc_def wage_def SA_def remit_def pension_def unemp_def property_def agri_inc_def adults employed, by(hhid /*quarter*/ year)
